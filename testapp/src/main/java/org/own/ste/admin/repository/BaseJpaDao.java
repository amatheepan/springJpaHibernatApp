...
import org.own.ste.admin.util.ReflectionUtil;
...
public class BaseJpaDao<T, ID extends Serializable> implements PagingAndSortingJpaDao<T, ID> {
    ...
    public T save(T obj) {
        ...
        T retVal = obj;
        if (id == null || em.find(myClass, id) == null) {
            em.persist(obj);
            em.flush();
        } else {
            retVal = em.merge(obj);
    ...
    public List<T> getAll() {
        return getEntityManager().createQuery(getAllQuery, myClass)
                .getResultList();
    }
     ...
     */
    private static <T> void addParamsToQuery(Map<String, Object> params,
            TypedQuery<T> query) {
        if (params != null) {
     ...
     * 
     * @param params Map<String, Object> - The parameters.
    ...
    /* (non-Javadoc)
     * @see org.tch.ste.infra.repository.PagingAndSortingJpaDao#getAllPaged(org.tch.ste.infra.repository.PageSort)
     */
    @Override
     ...
     * 
     * @param query TypedQuery<T> - The query.
     * @param pager PageSort - The paging criteria.
     */
    protected void applyPaging(TypedQuery<T> query, PageSort pager) {
        ...
        if (pager.getMax()!=null) {
            query.setMaxResults(pager.getMax());
        }
    }
     ...
     * 
     * @param query StringBuilder - The query.
     * @param pager PageSort - The sorting criteria.
     */
    ...
    /* (non-Javadoc)
     * @see org.tch.ste.infra.repository.PagingAndSortingJpaDao#findByNamePaged(java.lang.String, java.util.Map, org.tch.ste.infra.repository.PageSort)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.tch.ste.infra.repository.PagingAndSortingJpaDao#findByQueryPaged(java.lang.String, java.util.Map, org.tch.ste.infra.repository.PageSort)
     */
    @Override
    public List<T> findByQueryPaged(String query, Map<String, Object> params, PageSort pager) {
        ...
        TypedQuery<T> myQuery = getEntityManager()
                .createQuery(sortingQuery.toString(), myClass);
        addParamsToQuery(params, myQuery);
        applyPaging(myQuery,pager);
        return myQuery.getResultList();
    }
